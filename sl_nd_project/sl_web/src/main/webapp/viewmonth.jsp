...
<body style="background: url(${path}/imag/bulesky.jpeg)">
...
<script type="text/javascript">
    ...
    option1 = {
        title: {
            text: ${permonths[0].month}+'月不同商品销售量对比',
            left: 'center'
        },
        tooltip: {
            trigger: 'item',
        ...
        legend: {
            ...
            bottom: 20,
            data: [
                <c:forEach items="${permonths}" var="r">
                '${r.pname}',
                </c:forEach>
            ]
        },
        series: [
            {
                ...
                radius: '80%',
                center: ['45%', '55%'],
                data: [<c:forEach items="${permonths}" var="r">
                    {name:'${r.pname}',value:${r.amount}},
                    </c:forEach>],
                emphasis: {
                    itemStyle: {
                        shadowBlur: 10,
